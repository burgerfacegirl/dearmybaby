...
public class TourController {
    ...
    @ApiOperation(value = "여행 리스트 추천", notes = "<strong> familyId </strong>를 통해 여행지 리스트를 조회한다.")
    @GetMapping()
    ...
    @ApiOperation(value = "추천 여행지 단일 조회", notes = "<strong> tourId </strong>를 통해 추천 여행지를 조회한다.")
    @GetMapping("/detail")
