...
public class CommentController {
    ...
    @ApiOperation(value = "댓글 저장", notes = "댓글을 저장한다.")
    @PostMapping()
    ...
    @ApiOperation(value = "댓글 리스트 조회", notes = "<strong> recordId </strong>를 통해 댓글 리스트를 전체 조회한다.")
    @GetMapping("/comments")
    ...
    @ApiOperation(value = "댓글 삭제", notes = "<strong> commentId </strong>를 통해 댓글을 삭제한다.")
    @DeleteMapping()
