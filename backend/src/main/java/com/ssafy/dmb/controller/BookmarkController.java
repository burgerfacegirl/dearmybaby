...
//    }
    @ApiOperation(value = "북마크 리스트 조회", notes = "<strong> planId </strong>를 통해 북마크 리스트를 조회 한다.")
    @GetMapping("/{planId}")
    ...
    @ApiOperation(value = "북마크 저장", notes = "북마크 정보 저장 한다.")
    @PostMapping("/new")
    ...
    @ApiOperation(value = "북마크 리스트 삭제", notes = "<strong> bookmarkId </strong>를 통해 북마크를 삭제 한다.")
