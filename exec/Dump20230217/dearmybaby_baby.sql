...
CREATE TABLE `baby` (
  ...
  PRIMARY KEY (`baby_id`),
  KEY `FKb2xuijjdfe3n2etr0fqa2cr5b` (`family_id`),
  CONSTRAINT `FKb2xuijjdfe3n2etr0fqa2cr5b` FOREIGN KEY (`family_id`) REFERENCES `family` (`family_id`)
...
INSERT INTO `baby` VALUES (1473,1,'대희',1471),(1478,2,'aaaa',1476),(1482,1,'대희',1480);
...
-- Dump completed on 2023-02-17 11:50:52
